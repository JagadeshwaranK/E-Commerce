...
//   // Sample cart items (this would typically come from your cart context or state)
//   const [cartItems, setCartItems] = useState([
//     { id: 1, name: 'Example Product 1', price: 20.00, quantity: 2, image: 'path/to/image1.jpg' },
//     { id: 2, name: 'Example Product 2', price: 30.00, quantity: 1, image: 'path/to/image2.jpg' },
//   ]);
...
//                 {isShippingComplete && <span className="text-success">✔️</span>}
//               </div>
//             </Card.Header>
//             {currentStep === 1 && (
//               <Card.Body>
...
//                   </div>
//                 ))}
//                 <Button variant="primary" onClick={() => { setIsSummaryComplete(true); setCurrentStep(3); }}>
//                   Continue
//                 </Button>
//               </Card.Body>
//             )}
...
//                 <div>
//                   <p><strong>Total Quantity:</strong> {cartItems.reduce((total, item) => total + item.quantity, 0)}</p>
//                 </div>
//               </Card.Body>
//             )}
//           </Card>
...
//                 </ListGroup.Item>
//               </ListGroup>
//               <p>Your Total Savings on this order: $19.32</p>
...
//             <img src="path/to/spinning-coin.gif" alt="Order Placed" style={{ width: '100px', height: '100px' }} />
...
const Checkout = () => {
  ...
  // Sample cart items (this would typically come from your cart context or state)
  const [cartItems, setCartItems] = useState([
    { id: 1, name: ' Product 1', price: 20.00, quantity: 2, image: '/images/223_remington_ammo.jpg' },
    { id: 2, name: ' Product 2', price: 30.00, quantity: 1, image: '/images/223_remington_ammo.jpg' },
  ]);
